...
/* TRAGA TODOS OS REGISTROS DE FUNCIONARIOS*/
...
/* CONTANDO QUANTOS FUNCIONARIOS TEM NO DEPARTAMENTO FILMES E ROUPAS */
SELECT COUNT(*) FROM FUNCIONARIOS
WHERE DEPARTAMENTO = 'FILMES'; /* 21 */

SELECT COUNT(*) FROM FUNCIONARIOS
WHERE DEPARTAMENTO = 'ROUPAS'; /* 53 */

/* TRAZENDO OS FUNCIONARIOS DOS DEPARTAMENTOS ROUPAS E FILMES */
...
/* TRAZENDO A QUANTIDADE DE FUNCIONARIOS EM CADA DEPARTAMENTO */
SELECT COUNT(*), DEPARTAMENTO
FROM FUNCIONARIOS 
GROUP BY DEPARTAMENTO;

/* TRAZENDO A QUANTIDADE DE FUNCIONARIOS EM CADA DEPARTAMENTO POR ORDEM CRESCENTE */
SELECT COUNT(*), DEPARTAMENTO
FROM FUNCIONARIOS
group by DEPARTAMENTO
order by 1;
...
/* QUANDO USAMOS O OPERADOR AND E OR JUNTOS COLOCAMOS ENTRE PARENTES PARA CHECAR UMA TARCEIRA POSSIBILIDADE*/
SELECT * FROM FUNCIONARIOS
